...
products = [
    new Product("Album Olivia Rodrigo'SOUR'", 20000, "81bGstWK87L._UF350_350_QL80_-removebg-preview.png"),
    new Product("Album Billie Eilish'HIT ME HARD AND SOFT'", 10000, "388071m58f739b7-removebg-preview.png"),
    new Product("Album Arctic Monkeys'AM'", 20000, "3712676930.png"),
    new Product("Album Maneskin'IL BALLO DELLA VITA'", 10000, "maneskin-il-ballo-della-vita-2.png"),
